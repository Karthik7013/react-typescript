...
import { FETCH_POST, LOADING, LOGIN, LOGOUT, POST_DETAILS, SET_ALERT, SET_THEME, ADD_COMMENT } from "../ActionTypes/actionTypes";
...
export { handleLoading, handlePosts, handleLogin, handleLogout, handleTheme, handleAlert, handlePostDetails, handleAddComment }